    ...
    : QWidget(parent)
{
    ...
    QPixmap avatarPixmap(":/record/recordImage/user.jpg");  // 头像图片路径
    ...
    QPixmap progressPixmap(":/record/recordImage/learn.png");
    ...
    QPixmap scorePixmap(":/record/recordImage/score.png");
    ...
    QLabel *bestScoreValue = new QLabel(QString::number(bestScore), this);
